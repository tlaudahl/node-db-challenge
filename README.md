...
- A Relational Database is a database in it self and SQL is a language used to query the databse and get information back from it

- [ ] Why do tables need a `primary key`?

- Ensures you can access that specific row in the table
...
- A Foreign key and a primary key
